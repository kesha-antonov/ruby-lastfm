...
require_relative 'lastfm/util'
require_relative 'lastfm/response'
require_relative 'lastfm/http_request.rb'
require_relative 'lastfm/https_request.rb'
require_relative 'lastfm/method_category/base'
require_relative 'lastfm/method_category/album'
require_relative 'lastfm/method_category/artist'
require_relative 'lastfm/method_category/auth'
require_relative 'lastfm/method_category/event'
require_relative 'lastfm/method_category/geo'
require_relative 'lastfm/method_category/group'
require_relative 'lastfm/method_category/library'
require_relative 'lastfm/method_category/tag'
require_relative 'lastfm/method_category/tasteometer'
require_relative 'lastfm/method_category/track'
require_relative 'lastfm/method_category/user'
require_relative 'lastfm/method_category/chart'
require_relative 'lastfm/method_category/radio'
